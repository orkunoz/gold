...
export const TEXT_INVENTORY_FILTERS = ["barcode", "article", "weight"] as const;
export const SELECT_INVENTORY_FILTERS = ["producer", "size", "category", "status", "shop", "createdDate"] as const;
