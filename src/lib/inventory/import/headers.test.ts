...
describe("Excel header mapping", () => {
  ...
  it("suggests Ukrainian and English aliases", () => {
    expect(suggestColumnMapping(["Штрихкод", "Артикул", "Виріб", "Метал", "Виробник", "Вага", "Розмір", "Ціна", "Знижка", "Примітка", "Статус"]))
      .toMatchObject({ barcode: 0, article_number: 1, category: 2, producer: 4, weight_grams: 5, size: 6, status: 10 });
    expect(suggestColumnMapping(["Barcode", "Price Per Gram", "Shop", "Fineness"])).toEqual({ barcode: 0, price_per_gram: 1, shop: 2 });
