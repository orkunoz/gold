...
type InventoryMutationOperation = "create" | "create_batch" | "update" | "permanent_delete" | "bulk_move" | "bulk_price_change" | "bulk_purchase_price_change" | "bulk_delete" | "import_execute";
