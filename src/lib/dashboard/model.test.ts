...
describe("dashboard controls", () => {
  ...
  it("gives salespeople the inventory summary but no cross-shop comparisons", () => { expect(dashboardSections("salesperson")).toEqual({ inventory: true, comparisons: false, shopPerformance: false }); });
