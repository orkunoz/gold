...
export function dashboardSections(role: EmployeeRole) { return { inventory: role !== "salesperson", comparisons: role !== "salesperson", shopPerformance: role === "owner" }; }
...
export type DashboardReport = {
  ...
  status_counts: null | Record<"IN_STOCK" | "RESERVED" | "SOLD" | "REMOVED", number>;
