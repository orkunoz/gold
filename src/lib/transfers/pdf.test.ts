...
const transfer={transfer_number:"TR-20260913-000123",transferred_at:"2026-09-13T12:00:00Z",source_name:"Склад",destination_name:"Камінь",source_address:"вул. Центральна, 1",destination_address:null,performed_by_name:"Власник",item_count:1,total_weight:2.5,total_value:38320};
...
const labels={title:"Накладна переміщення",number:"Номер накладної",date:"Дата",from:"Звідки",to:"Куди",itemCount:"Вироби",totalWeight:"Загальна вага",totalValue:"Загальна вартість",performedBy:"Створив / виконав",sender:"Передав",receiver:"Прийняв",headings:["№","Виріб","Артикул","Виробник","Розмір","Вага","Ціна закупки","Ціна за грам","Ціна (грн)","Штрихкод"]};
