...
describe("Task 13 operational UI",()=>{
 ...
 it("keeps the exact inventory column sequence",()=>{expect(read("../app/(protected)/inventory/page.tsx")).toContain('["Nr", "Product Category", "Producer", "Metal", "Size", "Weight", "Price per Gram", "Article", "Price (UAH)", "Notes", "Status", "Shop", "Barcode"]');});
