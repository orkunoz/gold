...
describe("Task 13 operational UI",()=>{
 ...
 it("keeps the exact localized inventory column sequence",()=>{expect(read("./inventory-bulk-table.tsx")).toContain('["number","productCategory","producer","metal","fineness","size","weight","pricePerGram","article","priceUah","notes","status","shop","barcode"]');});
