...
describe("Task 13 operational UI",()=>{
 ...
 it("keeps the cleaned localized inventory column sequence",()=>{expect(read("./inventory-bulk-table.tsx")).toContain('["number","productCategory","article","producer","size","weight",...(canManage?["purchasePrice"]:[]),"pricePerGram","priceUah","status","shop","barcode"]');});
