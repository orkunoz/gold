...
describe("Task 13 operational UI",()=>{
 ...
 it("keeps the metal-free localized inventory column sequence",()=>{expect(read("./inventory-bulk-table.tsx")).toContain('["number","productCategory","producer","fineness","size","weight","pricePerGram","article","priceUah","notes","status","shop","barcode"]');});
