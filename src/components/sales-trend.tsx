...
export function SalesTrend({ points }: { points: Point[] }) {
  ...
  return <div className="w-full min-w-0 overflow-hidden" data-chart-container="no-scrollbars">
    <div className="relative h-56 w-full min-w-0 border-b border-stone-300 bg-[linear-gradient(to_top,rgba(168,162,158,0.15)_1px,transparent_1px)] bg-[size:100%_25%] pt-3" role="img" aria-label="Daily revenue chart with items sold and revenue tooltips">
