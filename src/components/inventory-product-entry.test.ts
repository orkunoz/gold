...
describe("manual product entry",()=>{
 ...
 it("uses proportional desktop grids for dense primary and secondary rows",()=>{const source=read("./inventory-draft-basket.tsx");expect(source).toContain("xl:grid-cols-[1.4fr_1.2fr_1.4fr_0.7fr_0.7fr_1fr_1fr_1fr]");expect(source).toContain("lg:grid-cols-[1.2fr_0.8fr_1fr]");expect(source).toContain("sm:col-span-2 lg:col-span-1")});
