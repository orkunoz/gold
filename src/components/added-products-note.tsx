...
.added-products-note .transfer-note__table th:nth-child(2){width:14%}
.added-products-note .transfer-note__table th:nth-child(3){width:10%}
.added-products-note .transfer-note__table th:nth-child(4){width:13%}
.added-products-note .transfer-note__table th:nth-child(5){width:6%}
.added-products-note .transfer-note__table th:nth-child(6){width:8%}
.added-products-note .transfer-note__table th:nth-child(7){width:10%}
.added-products-note .transfer-note__table th:nth-child(8){width:10%}
.added-products-note .transfer-note__table th:nth-child(9){width:15%}
.added-products-note .transfer-note__table th:nth-child(10){width:10%}
.added-products-note .transfer-note__table td:nth-child(5),.added-products-note .transfer-note__table td:nth-child(6),.added-products-note .transfer-note__table td:nth-child(7),.added-products-note .transfer-note__table td:nth-child(8),.added-products-note .transfer-note__table td:nth-child(10){white-space:nowrap;overflow-wrap:normal}
