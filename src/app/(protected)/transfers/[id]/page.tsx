...
export default async function TransferPage({params}:{params:Promise<{id:string}>}) {
  ...
  const displayTransfer={...transfer,source_name:historicalLocationDisplayName(transfer.source_name,locale),destination_name:historicalLocationDisplayName(transfer.destination_name,locale)};
