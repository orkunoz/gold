...
begin
  ...
  insert into public.shops(id,name,code) values(v_shop,'Task 5A Shop','TASK5A');
  ...
  select * into v_result from public.calculate_selling_price(100,gen_random_uuid(),v_category);
